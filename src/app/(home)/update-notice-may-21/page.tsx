    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="rounded-lg shadow-lg p-6 md:p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">21 May, 2025</p>
        </div>

        <div className="prose max-w-none">
          <p className="text-lg">
            We would like to inform our users of upcoming changes to the API on 31 May that will affect how you interact with the API.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-3">
            ...
            <li>
              <strong>Official Client Library:</strong> The API will now use the <code>openforis-whisp</code> package and its corresponding output. Please watch out for new properties/columns, including new risk categories.
            </li>
