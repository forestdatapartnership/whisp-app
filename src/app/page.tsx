...
export default function Home() {
  ...
  return (
    <main className="text-center mx-auto px-2 max-w-3xl">
      <h1 className="text-3xl font-semibold my-8">Welcome to Whisp</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 my-10 mx-4">
        <Link href="/submit-geo-ids" onClick={() => resetStore()} className="block p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
