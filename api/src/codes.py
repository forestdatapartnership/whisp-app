...
class SystemCode(str, Enum):
    ...
    ANALYSIS_CANCEL_INVALID = ("analysis_cancel_invalid", 409, "Analysis cannot be cancelled because it is no longer running. Check the status endpoint for the result.")
